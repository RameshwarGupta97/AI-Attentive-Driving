...
class ICM20948(object):
  ...
  def icm20948_Gyro_Accel_Read(self):
    ...
    return([Gyro[0]/32.8, Gyro[1]/32.8, Gyro[2]/32.8, Accel[0], Accel[1], Accel[2]])
  ...
  def icm20948CalAvgValue(self):
    ...
    MotionVal[7]=Mag[1]
    MotionVal[8]=Mag[2]
    return([Gyro[0]/32.8, Gyro[1]/32.8, Gyro[2]/32.8, Accel[0], Accel[1], Accel[2], Mag[0], Mag[1], Mag[2]])  
...
#     print('\r\nMagnetic:      X = %d , Y = %d , Z = %d'%((Mag[0]),Mag[1],Mag[2]))
    acceleration = math.sqrt(Accel[0]**2 + Accel[1]**2 + Accel[2]**2)
